...
(function(){
  ...
  function renderBasket() {
    ...
    function renderParent(b) {
      ...
      tdSection.className = 'section-cell cell-section';
      var secSelect = document.createElement('select');
      secSelect.className = 'section-select select';
      ...
      itemInput.className = 'editable item-input textarea';
      ...
      tdEx.className = 'cell-price';
      var exInput = document.createElement('input');
      exInput.type = 'number';
      exInput.step = '0.01';
      exInput.className = 'editable price-input input';
      ...
      for (var k = 0; k < kids.length; k++) {
        (function (s) {
          ...
          c2.className = 'sub-item-cell cell-item';
          var t = document.createElement('textarea');
          t.rows = 1;
          t.className = 'editable item-input textarea';
          t.value = s.item || '';
          t.oninput = function () {
            s.item = t.value;
            persistBasket();
    ...
    notesRow.className = 'tr notes-row';
