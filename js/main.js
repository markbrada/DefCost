...
function showPicker(reason){showStatus('<span class="status-error">Couldn\'t load <code>Defender Price List.xlsx</code> ('+reason+').</span> You can upload the workbook manually below.');if(pickerWrap)pickerWrap.style.display='block';}
...
window.addEventListener('error',function(e){showStatus("<span class='status-error'>Error:</span> "+e.message)});
